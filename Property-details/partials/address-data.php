...
if( !empty( $state ) && $hide_fields['state'] != 1 ) {
    echo '<li class="detail-state"><strong>'.houzez_option( 'spl_state', 'State' ).'</strong> <span>'.esc_attr( $state ).'</span></li>';
}//houzez_option($id,  , $param)return $houzez_options[spl_state][County/State]
